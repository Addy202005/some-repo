...
export default function BuyShares() {
  ...
  const totalCost = (parseFloat(stock.pricePerShare) * quantity).toFixed(6);
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      // const tx = await contract.buyShares(stock.symbol, qty, {
  ...
  return (
    <div className="page-container">
      <div className="trade-form-card">
        <div className="trade-form-header buy-header">
          <h2>🛒 Buy Shares</h2>
        </div>
        ...
        <div className="total-display">
          ...
          <span className="total-value buy-total">{totalCost} ETH</span>
        </div>
        ...
        <div className="form-actions">
          <button
            ...
            disabled={loading}
          >
            {loading ? 'Processing...' : `Buy ${quantity} Share(s)`}
          </button>
